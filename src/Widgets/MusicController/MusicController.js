    ...
    return(
        ...
        <div class="container-fluid">
            ...
            <div class="controller">
                ...
                <div class="volume">
                    <div><button class="btn btn-sm"><i class="fas fa-volume-up"></i></button></div>
                ...
                <div class="player-buttons">
                    <button class="btn  btn-sm" ><i class="fas fa-backward"></i></button>
                    <button  class="btn  btn-sm "><i class="fas fa-play"></i></button>
                    <button  class="btn  btn-sm"><i class="fas fa-forward"></i></button>
                </div>
